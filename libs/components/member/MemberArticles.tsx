...
const MemberArticles: NextPage = ({ initialInput, ...props }: any) => {
	...
	const {
		...
		onCompleted: (data: any) => {
			// bu ishga tushib member datasi yangilanadi
	...
	const likeArticleHandler = async (e: any, user: any, id: string) => {
		try {
			...
			await likeTargetBoardArticle({
				variables: {
					input: id, // aynan qaysi propertyga like bosilganini id si
				},
			});
...
function getBoardArticlesRefetch(arg0: { input: BoardArticlesInquiry }) {
